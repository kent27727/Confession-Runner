...
namespace FluffyUnderware.CurvyEditor
{
    ...
    public class AboutWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            GUI.backgroundColor = new Color32(136, 232, 214, 255);
            if (buttonCol("<b>Upgrade</b>", "Get the latest Curvy Splines upgrade"))
                OpenUpgrade();
        ...
        bool buttonCol(GUIContent btn, string text)
        {
            ...
            bool res = GUILayout.Button(btn, buttonStyle, GUILayout.Width(150));
        ...
        {
            Application.OpenURL("https://assetstore.unity.com/packages/slug/212532");
        }
