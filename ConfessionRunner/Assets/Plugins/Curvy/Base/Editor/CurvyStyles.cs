...
#pragma warning restore 162
        ...
        public static Texture2D IconUpgrade
        {
            get
            {
                if (mIconUpgrade == null)
                {
                    mIconUpgrade = CurvyResource.Load("upgrade,24,24");
                    mIconUpgrade.hideFlags = HideFlags.DontSave;
                }
                return mIconUpgrade;
            }
        }
        static Texture2D mIconUpgrade;
